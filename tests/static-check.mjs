...
assert.doesNotMatch(html, /id="ad-enabled"/);
assert.doesNotMatch(html, /id="enrich-button"/);
assert.doesNotMatch(html, /id="length-check"/);
...
assert.doesNotMatch(js, /MIN_AD_TEXT_LENGTH/);
assert.doesNotMatch(js, /buildAdHtml/);
assert.doesNotMatch(js, /appendVisibleEnrichment/);
...
assert.doesNotMatch(css, /length-check/);
